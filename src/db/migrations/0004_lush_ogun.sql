...
UPDATE "agent_connections" SET "auth_type" = 'headers' WHERE "auth_type" = 'header';--> statement-breakpoint
...
ALTER TABLE "agent_connections" ADD CONSTRAINT "agent_connections_security_revision_check" CHECK ("agent_connections"."security_revision" > 0);
