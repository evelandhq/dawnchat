...
export const TerminalCopyButton = ({
  ...
  return (
    <Button
      className={cn(
        "shrink-0 text-muted-foreground hover:bg-background hover:text-foreground",
        className
      )}
      ...
      {...props}
    >
      {children ?? <Icon className="size-3.5" data-icon="inline-end" />}
    </Button>
  );
};
...
export const TerminalClearButton = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <Trash2Icon className="size-3.5" data-icon="inline-end" />}
    </Button>
  );
};
...
export const Terminal = ({
  ...
  return (
    <TerminalContext.Provider value={contextValue}>
      <div
        className={cn(
          "flex flex-col overflow-hidden rounded-lg border bg-muted/50 text-foreground",
          className
        )}
        {...props}
      >
